...
interface UpsertRequest extends Request {
  prisma: PrismaClient
  body: Prisma.INVOICE_RECORDSUpsertArgs
...
export type UpsertMiddleware = RequestHandler<
  ParamsDictionary,
  any,
  Prisma.INVOICE_RECORDSUpsertArgs,
  Record<string, any>
>

export async function INVOICE_RECORDSUpsert(
  req: UpsertRequest,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    const data = await req.prisma.iNVOICE_RECORDS.upsert(req.body)
